...
import UserBiometricsPreview from '../preview/UserBiometricsPreview.component';
import UserManagementEdit from '../edit/UserManagementEdit.component';
...
const UserBiometricsManager = (props) => {
        ...
        <>
          ...
          <section className="content">
            {isEditMode ? (
              ...
              <UserBiometricsPreview entity={entityState?.entity[entityRef]} apiKey={apiKey} environment={environment} />
            )}
          </section>
        </>
      )}
...
export default UserBiometricsManager;
