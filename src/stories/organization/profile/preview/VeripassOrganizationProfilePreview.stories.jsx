...
import { VeripassOrganizationProfilePreview } from '../../../../components/organization/profile/preview/VeripassOrganizationProfilePreview';
import { AuthProvider } from '../../../../hooks/useAuth.hook';

export default {
  title: 'Organization/Profile/VeripassOrganizationProfilePreview',
  component: VeripassOrganizationProfilePreview,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
const Template = (args) => (
  <MemoryRouter>
    <AuthProvider {...args}>
      <VeripassOrganizationProfilePreview {...args} />
    </AuthProvider>
  </MemoryRouter>
);
