...
export default class SecurityProvisioningService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/security/provisioning/',
      create: '/security/provisioning',
      update: '/security/provisioning',
      delete: '/security/provisioning',
    };
