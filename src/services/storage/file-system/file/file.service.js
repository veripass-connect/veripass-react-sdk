...
export default class FileService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/storage/file-system/file/',
      create: '/storage/file-system/file',
      update: '/storage/file-system/file',
      delete: '/storage/file-system/file',
    };
