...
export default class OrganizationIdentityProviderService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/security/organization-identity-provider/',
      create: '/security/organization-identity-provider',
      update: '/security/organization-identity-provider',
      delete: '/security/organization-identity-provider',
    };
