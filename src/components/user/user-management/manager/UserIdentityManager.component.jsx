...
import UserIdentityPreview from '../preview/UserIdentityPreview.component';
import UserIdentityEdit from '../edit/UserIdentityEdit.component';
...
const UserIdentityManager = (props) => {
  const { entityState, entityRef, relatedEntities, loadingState, entityId, apiKey, environment } = props;
        ...
        <>
          ...
          <section className="content">
            {isEditMode ? (
              ...
              <UserIdentityPreview entity={entityState?.entity[entityRef]} apiKey={apiKey} environment={environment} />
            )}
          </section>
        </>
      )}
