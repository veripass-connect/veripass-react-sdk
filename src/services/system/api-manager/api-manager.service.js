...
export default class ApiManagerService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/system/api-manager/',
      create: '/system/api-manager',
      update: '/system/api-manager',
      delete: '/system/api-manager',
    };
