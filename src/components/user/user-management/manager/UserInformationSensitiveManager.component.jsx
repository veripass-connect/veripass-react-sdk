...
import UserInformationSensitivePreview from '../preview/UserInformationSensitivePreview.component';
import UserInformationSensitiveEdit from '../edit/UserInformationSensitiveEdit.component';
...
const UserInformationSensitiveManager = (props) => {
        ...
        <>
          ...
          <section className="content">
            {isEditMode ? (
              ...
              <UserInformationSensitivePreview
                entity={entityState?.entity[entityRef]}
                apiKey={apiKey}
                environment={environment}
              />
...
export default UserInformationSensitiveManager;
