...
export const VeripassQuickUserPreview = ({ entity, setIsOpen, isPopupContext }) => {
      ...
      {isLoading ? (
        ...
        <UserQuickViewContainer className="user-quick-view border-1 mx-auto rounded shadow">
          <article
            className={
              isPopupContext
                ? 'text-center card-body p-0'
                : 'text-center card-body p-0 border-bottom border-end border-start'
            }
          >
            <header className="position-relative mb-5">
              <CoverContainer className="user-quickview-cover-container rounded-top">
                <CoverImage
                  src={entity?.profile_ui_settings?.cover_picture_url ?? '/assets/images/cover/cover-11.jpg'}
                  alt="cover-image"
              ...
              <ProfileImage
                src={
                  entity?.profile_ui_settings?.profile_picture_url ??
            ...
            <section className="m-2">
              ...
              <article className="text-center">
                ...
                <p className="text-muted mt-1">
                  {entity?.identity ? <span className="">{entity?.identity}</span> : null}
                </p>
