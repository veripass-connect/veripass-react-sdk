...
export default class ApplicationEntitlementService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/user/application-entitlement/',
      create: '/user/application-entitlement',
      update: '/user/application-entitlement',
      delete: '/user/application-entitlement',
    };
