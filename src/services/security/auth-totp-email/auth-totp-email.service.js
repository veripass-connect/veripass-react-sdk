...
export default class AuthTotpEmailService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/security/auth-totp-email/',
      create: '/security/auth-totp-email',
      update: '/security/auth-totp-email',
      delete: '/security/auth-totp-email',
    };
