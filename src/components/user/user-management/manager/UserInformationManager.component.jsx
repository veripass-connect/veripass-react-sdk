...
import UserInformationPreview from '../preview/UserInformationPreview.component';
import UserInformationEdit from '../edit/UserInformationEdit.component';
...
const UserInformationManager = (props) => {
        ...
        <>
          ...
          <section className="content">
            {isEditMode ? (
              ...
              <UserInformationPreview entity={entityState?.entity[entityRef]} apiKey={apiKey} environment={environment} />
            )}
          </section>
        </>
      )}
