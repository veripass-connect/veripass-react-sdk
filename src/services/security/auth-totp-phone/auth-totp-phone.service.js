...
export default class AuthTotpPhoneService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/security/auth-totp-phone/',
      create: '/security/auth-totp-phone',
      update: '/security/auth-totp-phone',
      delete: '/security/auth-totp-phone',
    };
