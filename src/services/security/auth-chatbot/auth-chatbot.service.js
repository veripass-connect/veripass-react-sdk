...
export default class AuthChatbotService extends BaseApi {
  constructor(args) {
    super(args);
    ...
    this.serviceEndpoints = {
      ...
      get: '/security/auth-chatbot/',
      create: '/security/auth-chatbot',
      update: '/security/auth-chatbot',
      delete: '/security/auth-chatbot',
    };
