...
import UserMetadataPreview from '../preview/UserMetadataPreview.component';
import UserMetadataEdit from '../edit/UserMetadataEdit.component';
...
const UserMetadataManager = (props) => {
        ...
        <>
          ...
          <section className="content">
            {isEditMode ? (
              ...
              <UserMetadataPreview entity={entityState?.entity[entityRef]} apiKey={apiKey} environment={environment} />
            )}
          </section>
        </>
      )}
